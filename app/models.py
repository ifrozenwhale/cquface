...
class User(models.Model):
    ...
    cities = models.CharField(max_length=40)    # 城市
    age = models.CharField(max_length=40)   # 年龄
    qq = models.CharField(max_length=40)    # QQ
    sig = models.CharField(max_length=150)  # 个性签名
    email = models.CharField(max_length=40) # 邮箱
    head = models.CharField(max_length=100) # 头像的base64的txt文件的路径
